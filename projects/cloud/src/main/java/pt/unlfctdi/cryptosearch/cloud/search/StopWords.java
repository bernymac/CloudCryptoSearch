...
public class StopWords {
	...
	private Set<String> m_Words = null;
	...
	public StopWords() {
		setM_Words(new HashSet<String>(526));
	...
	public void add(String word) {
		if (word.trim().length() > 0)
			getM_Words().add(word.trim().toLowerCase());
	}
	...
	public boolean is(String word) {
		return getM_Words().contains(word.toLowerCase());
	}
	...
	public Set<String> getM_Words() {
		return m_Words;
	}

	public void setM_Words(Set<String> m_Words) {
